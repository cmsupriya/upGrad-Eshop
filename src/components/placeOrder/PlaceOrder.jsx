...
const PlaceOrder = () => {
	...
	const [displayMessage, setShowMessage] = useState("");
	...
	const initPageData = useCallback((data = json, redirect = navigate, displayMessage = showMessage) => {
		if(data === null) {
			displayMessage("Invalid access. Redirecting to home...", "warning");
			redirect("/home");
		}
	}, [json, navigate, showMessage]);
	useEffect(() => {
		initPageData();
	}, [initPageData]);
